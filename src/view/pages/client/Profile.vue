      ...
      <div class="flex q-mt-lg">
        <div class="col q-px-md">
          ...
          <div v-for="(location, index) in user.locations" :key="index">
            <div class="row q-my-xs">
              <div class="col-11">
                <DInputEdit class="col-12" placeholder="Dirección para recibir sus pedidos por delivery" label="Dirección" name="address" v-model="location.address" :index="index" :isDark="isDark" :edit="editAddress" @update="updateLocation"
